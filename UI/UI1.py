...
###   @LastEditTime: 2021-04-29 11:17:44
...
class UI1(Template):
    ...
    def __setup__(self):
        ...
        info_layout = Layout([self.info, 'space'], [], True)
        select_layout = Layout(
            ['space',
             Layout([self.button1, self.combo, self.button2], [], False),
             'space'], [1,1,1], True)
        layout = Layout(
            [info_layout, 'space', select_layout, 'space'],
            [1,1,1,1], False)
